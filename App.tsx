      ...
      <main id="main-content" className="flex-grow flex flex-col md:ml-64 mb-20 md:mb-0 min-h-screen relative overflow-y-auto overflow-x-hidden">
        ...
        <header className="sticky top-0 right-0 z-30 flex justify-end p-4 md:p-6 pointer-events-none">
          <div className="pointer-events-auto flex items-center space-x-3">
            {user ? (
              <div className="flex items-center bg-white/40 backdrop-blur-md border border-stone/30 rounded-2xl p-1.5 pl-4 shadow-sm hover:shadow-md transition-all group">
                ...
                <button
                  onClick={() => signOut()}
                  className="flex items-center space-x-2 px-4 py-2 bg-white/80 text-sm font-semibold text-stone-600 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all border border-transparent hover:border-red-100"
                >
                  <LogOut size={16} />
                  <span>Log Out</span>
                </button>
